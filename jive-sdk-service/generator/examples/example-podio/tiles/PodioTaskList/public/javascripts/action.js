...
function initialize(config, options, host) {
    ...
    $("#podioview").click(function() {
        gala && typeof gala === "object" ? window.open(config.taskUrl) : window.parent.open(config.taskUrl);
    });
    ...
    $("#create-discussion").click(function() {
        ...
        var obj = {
            ...
            "subject": $("#taskName").text() + ': ' + $("#subject").val(),
