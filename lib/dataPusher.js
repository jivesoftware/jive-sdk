        ...
        pushOperation( instance, dataToPush, pushURL ).then(
            ...
            function(response) {
                handleError( instanceLibrary, instance, response, retryIfFail,
                    function(instanceToRetry) { // retry push once if refreshtoken was reason for error
...
var fetch = function( fetchFunction, instance, type, fetchURL, callback, errCallback, retryIfFail ) {
    lookupLibrary(instance).then( function(instanceLibrary) {

        fetchFunction( instance, fetchURL ).then(
            // successful fetch
            function(response) {
                callback(response);
            },
            ...
            function(response) {
                handleError(instanceLibrary, instance, response, retryIfFail,
                    function(instanceToRetry) { // retry fetch once if refreshtoken was reason for error
                        fetch( instanceToRetry, type, fetchURL, callback, errCallback, false);
                    },
                callback, errCallback );
            }
        );
...
exports.fetchExtendedProperties = function( instance, callback, errCallback ) {
    fetch( jiveClient.fetchExtendedProperties, instance, 'extendedProperties', null, callback, errCallback, true );
};