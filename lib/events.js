...
exports.baseEvents = [
...

    {
        ...
        'handler' : function(theInstance, pushedData, response){
            jive.logger.debug('Data push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    },

    {
        ...
        'handler' : function(theInstance, pushedData, response){
            jive.logger.debug('Activity push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    },

    {
        'event': 'commentPushed',
        'handler' : function(theInstance, pushedData, response){
            jive.logger.debug('Comment push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    }
];
