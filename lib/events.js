...
exports.addEventListener = function( event, definitionName, listener, description ) {
    console.log("Registered event for", definitionName,": '" + event + "' ", description ||'' );
...
exports.baseEvents = [
...

    {
        ...
        'handler' : function(theInstance, pushedData, response){
            console.log('Data push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    },

    {
        ...
        'handler' : function(theInstance, pushedData, response){
            console.log('Activity push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    },

    {
        'event': 'commentPushed',
        'handler' : function(theInstance, pushedData, response){
            console.log('Comment push to', theInstance.url, response? response.statusCode : '', theInstance.name);
        },
        'description' : 'Framework handler'
    }
];
