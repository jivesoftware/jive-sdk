...
var requestMaker = function (method, serverInfo, path, headers, postBody, secure, requestOptions ) {
    ...
    return {
        execute: function (successCallback, errCallback) {
            ...
            var request = protocolHandler.request(options, function(response) {
