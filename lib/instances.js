...
exports.register = function (url, config, name, code ) {
    ...
    jiveClient.requestAccessToken(options,
        ...
        function (response) {
            ...
            instance['jiveCommunity'] = decodeURIComponent(scope.split(/:/)[1].split('/')[0]).split(/:/)[0];
...
exports.getExternalProps = function( instance ) {
    ...
    pusher.fetchExtendedProperties( instance,
        // success
        function(fetched) {
...
exports.setExternalProps = function( instance, props ) {
    ...
    pusher.pushExtendedProperties( instance, props,
        // success
        function(pushed) {
...
exports.deleteExternalProps = function( instance ){
    ...
    pusher.removeExtendedProperties( instance,
        // success
        function() {
            deferred.resolve();
        },
