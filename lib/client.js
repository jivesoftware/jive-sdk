...
exports.getWithTileInstanceAuth = function (tileInstance, url) {
    ...
    return jive.util.buildRequest(url, 'GET', null, reqHeaders).then(function (response) {
        if (!response.entity) {
            return response;
        }
...
exports.getPaginated = function(tileInstance, url) {
    var promise = exports.getWithTileInstanceAuth(tileInstance, url);
    return promise.then(function(entity){
        ...
        entity.next = function() {
            return exports.getPaginated(tileInstance, entity.links.next);
        };
...
exports.fetchExtendedProperties = function( instance ) {
    var fetchURL = extractExternalPropsUrl( instance );
    return jive.util.buildRequest( fetchURL, 'GET', null, { 'X-Client-Id': jive.service.options['clientId'] } );
};
