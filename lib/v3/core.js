...
/// xxx todo shouldn't this be a module
...
// base constructor for all collections of core types
    ...
    function createNodeJsRestAdapter() {
        // xxxx todo -- this is what we need to fix
        ...
        function executeImpl(runAs, callback) {
            ...
            /// xxx todo -  here we should try to use jiveutil.js#buildRequest()    ???
    ...
    function bootstrapRest() {
        ...
        if ($w.osapi && $w.osapi.newBatch) {
            ...
            // we must be in nodeJS land
            createNodeJsRestAdapter();
        } else {
            window.setTimeout(function() {
 ...
 *     });
     ...
     *     options : "activeOnly, count, fields, startIndex"
     */

    /**
     * Defines a static getter method which takes a single options argument
     * @param opts {Object} Options object may contain the following properties:
     *     activeOnly, count, fields, startIndex
     */ /*
     ...
     *     staticDef : "{\n    \"queryParams\": [\n        \"startIndex\",\n        \"sor..."
     *     methodName : "osapi.jive.corev3.events.get"
     *     options : "attachments, attendance, author, authors, authorship, cat..."
     */

    /**
     * Defines a static getter method which takes a single options argument
     * @param opts {Object} Options object may contain the following properties:
     *     attachments, attendance, author, authors, authorship, categories, city, content, count, country, email, endDate, eventAccess, eventType, fields, followerCount, highlightBody, highlightSubject, highlightTags, id, language, likeCount, location, maxAttendees, outcomeTypeNames, parent, parentContent, parentPlace, phone, published, replyCount, resources, sort, startDate, startIndex, status, street, subject, tags, type, updated, url, users, viewCount, visibility, visibleToExternalContributors
     */ /*
     ...
     *     staticDef : "{\n    \"queryParams\": [\n        \"startIndex\",\n        \"sor..."
     *     methodName : "osapi.jive.corev3.ideas.get"
     *     options : "author, authors, authorship, authorshipPolicy, categories..."
     */

    /**
     * Defines a static getter method which takes a single options argument
     * @param opts {Object} Options object may contain the following properties:
     *     author, authors, authorship, authorshipPolicy, categories, commentCount, content, count, fields, followerCount, highlightBody, highlightSubject, highlightTags, id, likeCount, outcomeTypeNames, parent, parentContent, parentPlace, published, replyCount, resources, score, sort, stage, startIndex, status, subject, tags, type, updated, users, viewCount, visibility, visibleToExternalContributors, voteCount, voted
     */ /*
